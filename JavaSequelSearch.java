 ...
 public String getAddress(){
  return Alamat;
    ...
    public static void main(String[] args) {
        ...
        cari=scan.next();
        for(i=0; i<Data.length; i++){
            String splitnama[]=Data[i].getName().split(" ");//split berfungsi untuk membatasi data yang dicari/memotong.
            for (j=0; j<splitnama.length; j++){
            //equals "Huruf Besar dan kecil berpengaruh" sedangkan equalsIGNORECASE "Huruf Besar dan kecil tidak berpengaruh"
